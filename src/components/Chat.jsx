...
//         // Add the bot's message or update progressively
//         setMessages((prevMessages) => {
//           const lastMessage = prevMessages[prevMessages.length - 1];

//           if (lastMessage?.sender === "bot") {
//             // Update the last bot message if it exists
//             return prevMessages.map((m, index) =>
//               index === prevMessages.length - 1 ? { ...m, text: resultText } : m
//             );
//           } else {
//             // Add a new bot message for the response
