...
//       async function ensureSingleThreadCreation() {
//         let threadValue;
//         if (!global.thread_value) {
//           try {
//             const thread = await openai.beta.threads.create();
//             global.thread_value = thread.id;
...
//           }
//         } else {
//           threadValue = global.thread_value;
//         }
//         return threadValue;
//       }

//       const assistant = await fetchAssistant();
//       const threadValue = await ensureSingleThreadCreation();

//       await openai.beta.threads.messages.create(threadValue, {
//         role: "user",
//         content: input,
//       });
